...
<div class="container-fluid">
    <form action="" id="manage_borrow">
        <div class="mt-3">
            ...
            <input type="text" id="book_number" name="book_number" class="form-control" value="<?php echo isset($meta['book_number']) ? $meta['book_number']: "" ?>" disabled>
        </div>
        <div class="mt-3">
        <input type="hidden" name="id" value="<?php echo isset($meta['id']) ? $meta['id'] : "" ?>">
            <label for="name" >Book</label>
            <select type="text" id="book_id" name="book_id" class="custom-select browser-default  select2"  disabled>
                <option value="" ></option>
            <?php 
        ...
        <div class="mt-3">
            ...
            <select type="text" id="borrower_id" name="borrower_id" class="custom-select browser-default select2" disabled>
                <option value=""></option>
        ...
        <div class="mt-3">
            ...
            <input type="text" id="date_borrowed" name="date_borrowed" class="form-control datepicker" value="<?php echo isset($meta['date_borrowed']) ? date('Y-m-d',strtotime($meta['date_borrowed'])) : date('Y-m-d') ?>" disabled>
        </div>
        <div class="mt-3">
            <label for="date_return">Returning Date</label>
            <input type="text" id="date_return" name="date_return" class="form-control datepicker" value="<?php echo isset($meta['date_return']) ? date('Y-m-d',strtotime($meta['date_return'])) : date('Y-m-d',strtotime(date('Y-m-d'). '+3 days')) ?>" disabled>
        </div>
        <?php if(isset($_GET['id'])): ?>
         <div class="mt-3">
            <label for="status">Status</label>
            <select type="text" id="status" name="status" class="custom-select browser-default" disabled>
